 ...
 * Supports Google and Apple Sign In / Sign Up
 * Displays buttons with inline SVG logos
 */
export function SocialLoginButtons({
  ...
  const modeText = mode === 'login' ? 'Continue' : 'Sign up'
  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <span>{modeText} with Google</span>
      </Button>
