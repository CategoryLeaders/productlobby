  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-primary-50 rounded-2xl p-8 sm:p-12 mb-16">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div>
              <div className="text-4xl font-bold text-primary-200 mb-2">01</div>
            ...
            <div>
              <div className="text-4xl font-bold text-primary-200 mb-2">02</div>
            ...
            <div>
              <div className="text-4xl font-bold text-primary-200 mb-2">03</div>
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/campaigns/new" className="bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-700 transition">Create a Campaign</Link>
