...
import { Trophy, AlertCircle, Clock, Users, Zap } from 'lucide-react'
...
const MOST_RESPONSIVE: BrandScore[] = [
  {
    rank: 1,
    name: 'Patagonia',
    logo: '🏔️',
    ...
    slug: 'patagonia',
    status: 'responsive',
    lastResponse: 'Extended Size Range - Path A',
  },
  {
    rank: 2,
    name: 'Allbirds',
    ...
    slug: 'allbirds',
    status: 'responsive',
    lastResponse: 'Carbon Negative Materials - Path B',
  },
  {
    rank: 3,
    name: 'Nike',
    ...
    slug: 'nike',
    status: 'responsive',
    lastResponse: 'Women\'s Running Shoes - Path B',
  },
  {
    rank: 4,
    name: 'IKEA',
    ...
    slug: 'ikea',
    status: 'responsive',
    lastResponse: 'Assembly Service - Path A',
  },
  {
    rank: 5,
    name: 'Dyson',
    ...
    slug: 'dyson',
    status: 'responsive',
    lastResponse: 'Student Discount - Path B',
  },
]

const LEAST_RESPONSIVE: BrandScore[] = [
  {
    rank: 1,
    name: 'Supreme',
    logo: '🎽',
...
const BrandRow = ({ brand }: { brand: BrandScore }) => {
  const isMostResponsive = MOST_RESPONSIVE.some(b => b.name === brand.name)
          ...
          <Tabs defaultValue="most-responsive" className="w-full">
            ...
            <TabsContent value="most-responsive" className="space-y-4">
              ...
              <div className="space-y-3">
                {MOST_RESPONSIVE.map((brand) => (
                  <BrandRow key={brand.rank} brand={brand} />
                ))}
              </div>
            </TabsContent>
